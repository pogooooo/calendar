...
const DynamicStickerInner = ({ isFilled, idx }: { isFilled: boolean, idx: number }) => {
...
// isFilled가 바뀐 슬롯만 재렌더 — 나머지는 스킵
export const DynamicSticker = React.memo(DynamicStickerInner);