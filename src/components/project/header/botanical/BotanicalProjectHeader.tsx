...
const BotanicalProjectHeader = React.forwardRef<HTMLDivElement, ProjectHeaderProps>(({
    selectedProject,
    selectedCategory,
    projects,
    selectedProjectId,
...
BotanicalProjectHeader.displayName = 'BotanicalProjectHeader';

export default BotanicalProjectHeader;
...
export const Tab = styled.div<{ $active: boolean }>`
    ...
    &:hover {
        ...
        background: ${(props) => props.theme.colors.primary}0E;
    }
`;
