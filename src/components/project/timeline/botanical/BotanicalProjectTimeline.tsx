...
import * as S from "./BotanicalTimeline.styles";
...
const BotanicalProjectTimeline = React.forwardRef<HTMLDivElement, ProjectTimelineProps>(
    ...
    React.useEffect(() => {
        ...
        const handleMouseUp = () => {
            ...
            const el = taskElemsRef.current.get(drag.taskId);
            lastMovedRef.current = drag.hasMoved;
...
BotanicalProjectTimeline.displayName = 'BotanicalProjectTimeline';
export default BotanicalProjectTimeline;
