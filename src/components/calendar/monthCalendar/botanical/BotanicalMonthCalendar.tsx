...
import * as S from "./BotanicalMonthCalendar.styles";
                ...
                return (
                    ...
                    >
                        <div className="day-header">
                            <S.DayHeaderLeft>
                                <span className="day-number"><span>{date.getDate()}</span></span>
...
type BotanicalMonthProps = MonthThemeProps & Omit<React.HTMLAttributes<HTMLDivElement>, 'contextMenu'>;

const BotanicalMonthCalendar = React.forwardRef<HTMLDivElement, BotanicalMonthProps>(
    ({
...
BotanicalMonthCalendar.displayName = "BotanicalMonthCalendar";

export default BotanicalMonthCalendar;
