...
import * as S from "./BotanicalTodoModal.styles";
...
export default function BotanicalTodoModal({
    ...
    return (
        <BotanicalBaseModal isOpen={isOpen} onClose={onClose} maxWidth="420px">
                    ...
                    <S.DropdownContainer onClick={(e) => e.stopPropagation()} style={{ marginBottom: '8px', padding: '0 8px' }}>
                        <S.DropdownHeader onClick={() => {
                            ...
                            <div className="content-wrapper">
                                <S.ColorDot $color={selectedCategory?.color || "#D9CFC7"} />
                            ...
                            <S.RepeatConditionBox>
                                ...
                                <S.DropdownContainer onClick={(e) => e.stopPropagation()}>
                                    <S.DropdownHeader onClick={() => {
                                        ...
                                        {isRepeatEndOpen ? <ChevronUp size={18} /> : <ChevronDown size={18} />}
                                    </S.DropdownHeader>
