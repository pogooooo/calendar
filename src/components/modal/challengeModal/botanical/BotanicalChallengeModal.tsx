...
export default function BotanicalChallengeModal({
    ...
    return (
        <BotanicalBaseModal isOpen={isOpen} onClose={onClose} maxWidth="450px">
            <S.ModalHeader>
