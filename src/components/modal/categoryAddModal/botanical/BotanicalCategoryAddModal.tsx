...
import * as S from "./BotanicalCategoryAddModal.styles";
...
export default function BotanicalCategoryAddModal({
    isOpen, onClose,
    name, setName,
    color, setColor,
    ...
    return (
        <BotanicalBaseModal isOpen={isOpen} onClose={onClose} maxWidth="400px">
